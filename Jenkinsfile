...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.53.253:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-bankoue', //update and provide your channel name
